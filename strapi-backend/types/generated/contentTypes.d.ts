...
export interface ApiLecturerLecturer extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lecturer_for: Attribute.Relation<
      'api::lecturer.lecturer',
      'oneToMany',
      'api::subject.subject'
    >;
    tutorials_for: Attribute.Relation<
      'api::lecturer.lecturer',
      'oneToMany',
      'api::subject.subject'
    >;
...
export interface ApiStudentResourceFolderStudentResourceFolder
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    resource_location: Attribute.Enumeration<
      ['Dropbox', 'Google Drive', 'OneDrive', 'YouTube']
    > &
      Attribute.Required;
...
export interface ApiSubjectSubject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lectures_by: Attribute.Relation<
      'api::subject.subject',
      'manyToOne',
      'api::lecturer.lecturer'
    >;
    tutorials_by: Attribute.Relation<
      'api::subject.subject',
      'manyToOne',
      'api::lecturer.lecturer'
    >;
    description: Attribute.Text;
    trimesters: Attribute.Relation<
      'api::subject.subject',
      'manyToMany',
      'api::trimester.trimester'
    >;
    tutorial_weeks: Attribute.Relation<
      'api::subject.subject',
      'manyToMany',
      'api::tutorial-week.tutorial-week'
    >;
    Tutorial_Time: Attribute.Time & Attribute.Required;
...
export interface ApiTrimesterTrimester extends Schema.CollectionType {
...
export interface ApiTutorialWeekTutorialWeek extends Schema.CollectionType {
  ...
  attributes: {
    week_number: Attribute.Integer &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    master_tz: Attribute.String &
      Attribute.Required &
      Attribute.CustomField<'plugin::timezone-select.timezone'>;
    start_date_tri1: Attribute.Date & Attribute.Required;
    subjects: Attribute.Relation<
      'api::tutorial-week.tutorial-week',
      'manyToMany',
      'api::subject.subject'
    >;
    start_date_tri2: Attribute.Date & Attribute.DefaultTo<'2024-06-03'>;
    start_date_tri3: Attribute.Date & Attribute.DefaultTo<'2024-09-16'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::trimester.trimester': ApiTrimesterTrimester;
      'api::tutorial-week.tutorial-week': ApiTutorialWeekTutorialWeek;
    }
  }
}
